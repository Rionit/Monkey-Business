...
namespace MonkeyBusiness.Perks
{
    public class PerkSelectionController : MonoBehaviour
    {
        ...
        [BoxGroup("Perk Manager Setup"), Required,
         Tooltip("Parent object that will contain instantiated perk UI elements.")]
        [SerializeField]
        private GameObject perkSelectionUI;

        [BoxGroup("Perk Manager Setup"), Required, Tooltip("List of all available perks.")] [SerializeField]
        private List<PerkSO> perks;
